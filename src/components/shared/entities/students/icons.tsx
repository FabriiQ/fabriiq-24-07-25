...
export const BookMarked: React.FC<IconProps> = ({
  size = 24,
  strokeWidth = 2,
  ...props
}) => {
...
// Convert IconProps to LucideProps for compatibility
export const iconToLucide = (Icon: React.FC<IconProps>): React.FC<LucideProps> => {
